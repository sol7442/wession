...
/*     */   {
/* 142 */     if (!this.useable) return;
/*     */ 
/* 144 */     StopWatch watch = new StopWatch(TimeUnit.NANOSECONDS);
/* 145 */     JournalEntity entity = new JournalEntity(2);
/* 146 */     entity.addData(key);
/* 147 */     this.journalFile.append(entity);
/* 148 */     this.weslogger.debug("remove : key[{}]-{}", key, Long.valueOf(watch.stop()));
/*     */   }
/*     */ 
/*     */   public void add(String parent, ISession session) {
/* 152 */     if (!this.useable) return;
/*     */ 
/* 154 */     StopWatch watch = new StopWatch(TimeUnit.NANOSECONDS);
/* 155 */     JournalEntity entity = new JournalEntity(10);
/* 156 */     entity.addData(parent);
/* 157 */     entity.addData(session);
/* 158 */     this.journalFile.append(entity);
/* 159 */     this.weslogger.debug("add : parent[{}],session[{}]-{}", new Object[] { parent, session, Long.valueOf(watch.stop()) });
/*     */   }
/*     */   public void remove(String parent, String key) {
/* 162 */     if (!this.useable) return;
/*     */ 
/* 164 */     StopWatch watch = new StopWatch(TimeUnit.NANOSECONDS);
/* 165 */     JournalEntity entity = new JournalEntity(11);
/* 166 */     entity.addData(parent);
/* 167 */     entity.addData(key);
/* 168 */     this.journalFile.append(entity);
/* 169 */     this.weslogger.debug("remove : parent[{}],key[{}]-{}", new Object[] { parent, key, Long.valueOf(watch.stop()) });
/*     */   }
...
/* 175 */     JournalEntity entity = new JournalEntity(21);
/* 176 */     entity.addData(parent);
/* 177 */     entity.addData(key);
/* 178 */     entity.addData(object);
/* 179 */     this.journalFile.append(entity);
/* 180 */     this.weslogger.debug("set : parent[{}],key[{}],object[{}]-{}", new Object[] { parent, key, object, Long.valueOf(watch.stop()) });
/*     */   }
/*     */   public void delete(String parent, String key) {
/* 183 */     if (!this.useable) return;
/*     */ 
/* 185 */     StopWatch watch = new StopWatch(TimeUnit.NANOSECONDS);
/* 186 */     JournalEntity entity = new JournalEntity(22);
/* 187 */     entity.addData(parent);
/* 188 */     entity.addData(key);
/* 189 */     this.journalFile.append(entity);
/* 190 */     this.weslogger.debug("delete : parent[{}],key[{}]-{}", new Object[] { parent, key, Long.valueOf(watch.stop()) });
/*     */   }
/*     */   public void clear() {
/* 193 */     if (!this.useable) return;
/*     */ 
/* 195 */     StopWatch watch = new StopWatch(TimeUnit.NANOSECONDS);
/* 196 */     JournalEntity entity = new JournalEntity(99);
/* 197 */     this.journalFile.append(entity);
/* 198 */     this.weslogger.debug("clear:-{}", Long.valueOf(watch.stop()));
/*     */   }
/*     */ }
