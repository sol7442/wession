...
<jsp:include page="../inc/header_menu_right.jsp" flush="true" />
					...
					<ul id="menu">
						...
						<li class="active"><a href="#"> <%= company_policy %> 인증정책<i class="icon-angle-down icon-1x pull-right"></i></a>
							<ul class="submenu collapse in">
								...
								<li class="active"><a href="./duplogin_adopt.jsp"><i class="menu-icon icon-caret-right "></i> 중복로그인 적용정책</a></li>
			...
			<section class="content">
				...
				<div class="page">
					<div class="page-header">
						...
						<h1>
							<%= company_policy %> 인증정책 <small><i class="icon-double-angle-right"></i> 중복로그인 적용정책 </small>
						</h1>
					</div>
					...
					<div class="modal-body">
						<form role="form" id="modal-form" class="form-horizontal">
							<div class="form-group form-group-sm">
								<label for="data" class="col-xs-2 control-label"  id="data1_label"></label>
								<div class="col-xs-7">
 ...
 -->
	...
	<input type="hidden" id="allowed" name="allowed" value="<%= default_policy.equals("deny")?"DY":"AW" %>" />
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#launch").on("click", function() {
				if (confirm("중복로그인 적용 정책을 로딩 하시겠습니까?") == false)
				    return;
			...
			$("#export").on("click", function() {
				window.open("../../json/export.jsp?type=policy_DA");
			});
			$("[rel=tooltip]").tooltip({
				delay : {
					show : 10,
