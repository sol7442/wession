...
<%
	...
	String active_class_AA = policycode.equals("AA") ? "active" : "";
	String active_class_AL = policycode.equals("AL") ? "active" : "";
	String active_class_DA = policycode.equals("DA") ? "active" : "";
	String active_class_DL = policycode.equals("DL") ? "active" : "";
		...
		<header class="header-wrapper">
			<nav class="navbar navbar-default navbar-static-top">
				...
				<ul class="nav navbar-nav">
					...
					<li class=""><a href="../agent/agent.jsp">agent</a></li>
		...
		<div class="clearfix">
			<aside class="sidebar">
				<nav class="sidebar-nav">
					<ul id="menu">
						...
						<li class="active"><a href="#"> 정책수행결과 조회<i class="icon-angle-down icon-1x pull-right"></i></a>
							<ul class="submenu collapse in">
								<li class="<%=active_class_AA%>"><a href="./policyviolation.jsp?policycode=AA"><i class="menu-icon icon-caret-right "></i> 접속IP 적용정책</a></li>
								<li class="<%=active_class_AL%>"><a href="./policyviolation.jsp?policycode=AL"><i class="menu-icon icon-caret-right "></i> 접속IP 허용정책</a></li>
								<li class="<%=active_class_DA%>"><a href="./policyviolation.jsp?policycode=DA"><i class="menu-icon icon-caret-right "></i> 중복로그인 적용정책</a></li>
								<li class="<%=active_class_DL%>"><a href="./policyviolation.jsp?policycode=DL"><i class="menu-icon icon-caret-right "></i> 중복로그인 허용정책</a></li>
							</ul></li>
			...
			<section class="content">
				<ol class="breadcrumb">
					...
					<li>정책수행결과 조회</li>
					<li><%=policycode.equals("AA") ? "접속IP 적용정책" : (policycode
					.equals("AL") ? "접속IP 허용정책" : (policycode.equals("DA")
					? "중복로그인 적용정책"
					: "중복로그인 허용정책"))%></li>
				</ol>
				<div class="page">
					<div class="page-header">
						...
						<h1>
							Policy Violation <small><i class="icon-double-angle-right"></i> </small>
						</h1>
					</div>
					<div class="page-body" style="margin-top: -30px;">
						<div id="toolbar">
							<div class="input-group" style="width: 200px;">
								<input class="form-control" type="text" name="logdate" id="logdate" value="<%=today%>" style="display: inline;" /> <span class="input-group-btn">
 ...
 -->
	...
	<script type="text/javascript">
		$(function() {
			...
			var $table = $("#wss_tbl"), 
				options = {
				url : "../../json/wession_policy_violation.jsp?logtype=<%=policycode%>&logdate="+$("#logdate").val(),
				pagination : true,
				search : true,
				striped : true,
				pageSize : 20,
			...
			$("#btn_move").on("click", function(e) {
				$.getJSON("../../json/wession_policy_violation.jsp?logtype=<%=policycode%>&logdate="+$("#logdate").val()).done(function(data) {
		...
		$("#btn_export").on("click", function(e) {
			window.open("../../json/export.jsp?type=policy_violation&logtype=<%=policycode%>&logdate=" + $("#logdate").val());
		});
