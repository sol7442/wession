...
<jsp:include page="../inc/header_menu_right.jsp" flush="true" />
					...
					<ul id="menu">
						...
						<li class="active"><a href="#"> <%= company_policy %> 인증정책<i class="icon-angle-down icon-1x pull-right"></i></a>
							<ul class="submenu collapse in">
								<li class="active"><a href="./authip_adopt.jsp"><i class="menu-icon icon-caret-right "></i> 접속IP 적용정책</a></li>
			...
			<section class="content">
				...
				<div class="page">
					<div class="page-header">
						...
						<h1>
							<%= company_policy %> 인증정책 <small><i class="icon-double-angle-right"></i> 접속IP 적용정책 </small> 
	...
	<form name="policy_frm" id="policy_frm" method="post" action="../../json/policy_save.jsp" >
		...
		<input type="hidden" id="policycode" name="policycode" value="AA" />
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#export").on("click", function() {
				window.open("../../json/export.jsp?type=policy_AA");
			});
