			...
			<aside class="sidebar">
				<nav class="sidebar-nav">
					<ul id="menu">
						...
						<li class="active"><a href="policyviolation.jsp"> Policy Violation </a></li>
					</ul>
 ...
 -->
	...
	<script type="text/javascript">
		$(function() {
			...
			var $table = $("#wss_tbl"), 
				options = {
				url : "../../json/wession_policy_violation.jsp?logdate="+$("#logdate").val(),
				pagination : true,
				search : true,
				striped : true,
				pageSize : 20,
			...
			$("#btn_move").on("click", function(e) {
				$.getJSON("../../json/wession_policy_violation.jsp?logdate="+$("#logdate").val()).done(function(data) {
		...
		$("#btn_export").on("click", function(e) {
			window.open("../../json/export.jsp?type=policy_violation&logdate="+$("#logdate").val());
		});
