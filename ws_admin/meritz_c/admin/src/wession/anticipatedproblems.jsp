	    ...
	    <aside class="sidebar">
	      <nav class="sidebar-nav">
	        <ul id="menu">
	          ...
	          <li class=""><a href="wession.jsp"> Current Wession List </a></li>
	          <li class="active"><a href="anticipatedproblems.jsp"> Anticipated Problems </a></li>
	          <!-- 
	    ...
	    <section class="content">
	      ...
	      <div class="page">
	        <div class="page-header">
	          ...
	          <h1>Anticipated Problems <small><i class="icon-double-angle-right"></i> </small></h1>
	        </div>
	        <div class="page-body">
	          <div id="toolbar" class="btn-group">
	              <button class="btn color color-asbestos" type="button" name="btn_remove" id="btn_remove"><i class="icon-remove-sign"></i> Remove Session</button>
	          </div>
	...
	<script type="text/javascript">
		$(function() {
			var $table = $("#wss_tbl"), options = {
				url : '../../json/wession_violation.jsp',
			...
			$("#btn_allremove").on("click", function(e) {
				deleteWessesion('all');
			});
			$("[rel=tooltip]").tooltip({
				delay : {
